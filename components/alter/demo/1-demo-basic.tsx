...
import Alert from 'happy-ui/lib/alter';
// import SelectUser, { PropTypes } from 'happy-ui/src/index';
import 'happy-ui/lib/alter/style';
...
export default () => {
  ...
  return (
    <div>
      <div>{/* <div onClick={show}>唤起选人组件</div> */}</div>
      <Alert kind="warning">eeeee</Alert>
    </div>
  );
};
