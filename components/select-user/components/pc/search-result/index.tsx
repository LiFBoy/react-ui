        ...
        {userList.length > 0 ? (
          <React.Fragment>
            ...
            {userList.map((user, index) => {
              ...
              return (
                <div className="search-result-group-item" key={`${user.userId}-${index}`}>
                  <UserIcon />
        ...
        {deptList.length > 0 ? (
          <React.Fragment>
            ...
            {deptList.map((dept: any, index: number) => {
              ...
              return (
                <div className="search-result-group-item" key={`${dept.deptId}-${index}`}>
                  <DeptIcon />
                  <div className="search-result-item-detail">
        ...
        {orgList.length > 0 ? (
          <React.Fragment>
            ...
            {orgList.map((org: any, index: number) => {
              ...
              return (
                <div className="search-result-group-item" key={`${org.orgId}-${index}`}>
                  <OrgIcon />
                  <div className="search-result-item-detail">
                    <div className="search-result-item-title">
        ...
        {groupList.length > 0 ? (
          <React.Fragment>
            ...
            {groupList.map((group: any, index: number) => {
              ...
              return (
                <div className="search-result-group-item" key={`${group.groupId}-${index}`}>
                  <GroupIcon />
                  <div className="search-result-item-detail">
                    <div className="search-result-item-title">
        ...
        {tagList.length > 0 ? (
          <React.Fragment>
            ...
            {tagList.map((tag: any, index: number) => {
              ...
              return (
                <div className="search-result-group-item" key={`${tag.tagCode}-${index}`}>
                  <TagIcon />
                  <div className="search-result-item-detail">
                    <div className="search-result-item-title">
